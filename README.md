...
In `./tsLogger_example/main.cpp` (linked [here](https://silicondosa.github.io/tsLogger/main_8cpp_source.html)), you can find an example to get you started and its output is in `./tsLogger_example/testFile.csv`.

Doxygen-generated HTML documentation is available [here](https://silicondosa.github.io/tsLogger/).
